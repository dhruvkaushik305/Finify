  ...
  return (
    <main className="flex flex-col justify-between rounded-tl-[2rem] w-full p-5 bg-[#FAFAFA]  border border-slate-200">
      ...
      <section className="grid grid-cols-2 gap-5">
        <div className="bg-secondary/80 text-black min-h-[150px] w-full rounded-3xl p-5 flex flex-col shadow-lg">
      ...
      <section className="flex flex-col gap-3 items-start">
        <header className="text-2xl font-medium">Weekly expediture</header>
        <Graph />
      </section>
    </main>
  );
